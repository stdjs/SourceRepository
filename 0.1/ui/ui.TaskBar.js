    ...
    public:{
        ...
        */
        actived:function(actived){
            ...
            return that.opt("actived",actived,function(){
                var parent = that.parent();

                that[0].toggleClass("actived",actived);
                that.emit("active",actived);
                parent.emit("itemActive",[actived,that],true);
        ...
        */
        createItem:function(data){
            ...
            if(isWidget(data)){
                ...
                item = Std.ui(data.ui || "TaskBar_Item",data || {});
            }else if(isString(data) || isNumber(data)){
                item = Std.ui("TaskBar_Item",{
                    text:data
                });
            }
            if(isWidget(item)){
