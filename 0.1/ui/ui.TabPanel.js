    ...
    private:{
        ...
        */
        createTab:function(config){
            ...
            var button          = null;
            var content         = null;
            var tabButtonHeight = this.opts.tabButtonHeight;

            if(isString(config.button)){
                button = Std.ui("TabButton",{
                    parent:that,
                    text:config.button,
                    height:tabButtonHeight
                });
            }else if(isObject(config.button)){
                config.button.parent = that;
                config.button.height = tabButtonHeight;
                button = Std.ui("TabButton",config.button);
            }
